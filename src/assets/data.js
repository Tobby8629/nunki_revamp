...
export const products = [
  {
    ...
    24/7`,
    benefits: [
      {id: 0, benefit:" covers the structure and contents of your home should it be destroyed in a fire, storm, wind  or flooding."}, 
      {id:1, benefit:"Claim settlement is through gift cards/vouchers. No cash Settlement will be allowed"},
      {id:2, benefit:"compensation will be allowed as follows."},
      {id:3, table_head:["Insured Amount", "Building Benefit", "content Benefit", "monthly premium"], table_body: [
        {
...

  {
    ...
    benefits: [
      ...
      {id:1, benefit:"Claim settlement is through gift cards/vouchers. No cash Settlement will be allowed"},
      {id:2, benefit:"compensation will be allowed as follows."},
      {id:3, table_head:["Insured Amount", "monthly premium"], table_body: [
        {
...

  {
...

   {
    ...
    benefits: [
      {id: 0, benefit:"Summaries: Customized to the textbooks used by your child's school"}, 
      {id:1, benefit:"Samplo Examinations: Aligned with the chosen textbook."},
      {id:2, benefit:"Heip with Speecnes; Assistance in writing effective speeches."},
      {id:3, benefit:"Assignments: Providing content and images required for assignments "},
      {id:4, benefit:"Literature: Ovorviews and comprohension tools for prescribed literature."},
      {id:5, benefit:"Mathematics: Step-by-step problem-solving guidance. terminology overviews. and practice sncels."},
      {id:6, benefit:"Languages: Comprehensive support for Afrikaans and English, including ptacuce sntels"}
    ],
    price:225,
    productImage: Tutor,
   },

  {
    ...
    benefits: [
      ...
      {id:5, benefit:"Coordination with next of kin for travel to the burial site with the service provider"},
...

  {
    ...
    benefits: [
      {id: 0, benefit:"Symptom assessment and referral to the right healthcare professionals"}, 
      {id:1, benefit:"Information on healticare, including home remedies, with follow-up calls"},
      {id:2, benefit:"Explanation of medical terms, test results, and medication details"},
      {id:3, benefit:"counseling for chronic diseases to reduce their daily impact"},
      {id:4, benefit:"Access to South Africa's top drug and poison database."},
      {id:5, benefit:"Telephonic trauma debriefing and referral to a trauma counseior if necessary."},
      {id:6, benefit:"Access to an audio health library with information on various medical topics"}
    ],
    price:225,
 ...
 
  {
    ...
    benefits: [
      {id: 0, benefit:" Immediate access to a 24-hour Emergency medical assistance Contact Centre"}, 
      {id:1, benefit:"Aid provided by certified medical agents registered with the HPCSA"},
      {id:2, benefit:"Swift dispatch of emergency medical services to deliver life-saving support."},
      {id: 3, benefit: "Ongoing monitoring of the situation until the member reaches the hospital."},
      {id: 4, benefit: "Provision of Emergency Pre-Arrival instructions by our trained agents, including CPR."},
      {id: 5, benefit: "Emergency transportation facilitated via air or road ambulance"},
      {id: 6, benefit: "Upgrade to an appropriate medical facility to ensure continued care if the initial treating facility is unable to manage the member's condition"},
      {id: 7, benefit: " Repatriation of the member to a treatment facility closer to their residence if the incident occurs more than 200km away from the members place of residence"},
      {id: 8, benefit: "Access to non-emergency medical transportation at the member's own cost"},
      {id: 9, benefit: "Payment of medical transportation expenses"},
      {id:10, benefit: "Access to the largest national network of emergency medical service providers."},
      {id:11, benefit: "Detailed daily, monthly, or quarterly reporting of Contact Centre interactions and claims statistics"}
    ], 
    funeralSection: {
      section: [ "A", "B", "C" ],
      planA: {
        table1:{ 
          title: "The Member, Spouse and Children of the Member will benefit from the following cover: ",
        ...
        table2:{ 
          title: "Policy's total monthly premium based on thr principal life's age next birthday, at entry for either a family or single policy: ",
          tableHeader: [" ","family", "single"], 
          tableBody:  [
            {
              age: "< 50",
  ...
  
  {
    ...
    benefits: [
      ...
      {id:1, benefit:" 24/7 telephonic trauma debriefing by qualified nurses, with referrals if needed."},
      {id:2, benefit:" Face-to-Face Trauma Counselling."},
      {id: 3, benefit: "If the nurse’s assessment indicates the need for professional assistance, a face-to-face counselling session will be arranged."},
      {id: 4, benefit: "The caller will be referred to local social workers or psychologists for counselling sessions, with costs paid by the patient."}
    ]
...

  {
    ...
    benefits: [
      {id: 0, benefit:" Emergency transport to the nearest, most appropriate medical facility if needed."}, 
      {id:1, benefit:" Assault cover: R5,000 per person, up to R10,000 per family per incident for medical treatment."},
      {id:2, benefit:"Trauma cover: R5,000 per person, up to R10,000 per family per incident for psychological consultations.."},
      {id: 3, benefit: "24-hour access to trauma counsellors for telephonic and post-traumatic stress disorder counselling."},
      {id: 4, benefit: "Up to 3 specialist consultations per incident with a general practitioner, trauma nurse, or trauma counsellor."},
      {id: 5, benefit: "Up to 3 HIV blood tests per incident: immediately after the event, at 6 weeks, and at 3 months. Further testing not covered if the initial test is positive."},
      {id: 6, benefit: "Benefits include antiretroviral medication, STI medication,‘morning-after pill’ and ongoing counselling, provided exposure is confirmed and the member was HIV negative at the time of the incident."},
    ]
  },

  {
    ...
    productImage: cash,
    benefits: [
      {id: 0, benefit:" Members get 10% off tombstones with Doves Funeral Services."}, 
      {id:1, benefit:" Members get a R1000 discount when spending R7500 or more on coffins and funeral services with Doves Funeral Services."},
      {id:2, benefit:"Members get a R500 discount when spending between R4500 and R7499 on coffin and funeral services with Doves Funeral Services."},
      {id: 3, benefit: "Members save 15% on funeral services and coffins at AVBOB."},
      {id: 4, benefit: "Members save 10% with Net Florist."},
      {id: 5, benefit: "Members get 15% OFF all printing services with HI Colour."},
      {id: 6, benefit: "Members get an 8% discount with Flowers.co.za."},
      {id: 7, benefit: "Rent with Europcar from as little as R185 per day"},
      {id: 8, benefit: "Members get a special Car Hire rate with First Car Rental"},
...

  {
    ...
    benefits: [
      {id: 0, benefit:" Access to all private hospitals accepting health insurance products. Pre-authorisation required."}, 
      {id:1, benefit:"R225 000 per Insured per event. Maximum of R1 000 000 per policy per annum."},
      {id:2, benefit:"Shortfall Benefit."},
      {id: 3, benefit: "ICU Benefit"},
      {id: 4, benefit: "R10 000 per Insured per event for physiotherapy and occupational therapy only."},
      {id: 5, benefit: "Casualty (Accident) Benefit R30 000 per policy"},
      {id: 6, benefit: "Casualty (Illness) R15 000 per policy per annum for Emergency Stabilisation in the case of an Illness"},
      {id: 7, benefit: "2 GP consultations at a contracted network doctor per Insured"},
      {id: 8, benefit: "Defined list of procedures a Network GP can perform in their rooms at no additional charge"},
      {id: 9, benefit: " 3 visits per Insured for a defined list of procedures available from nurses at Network pharmacies with contracted clinics"},
      {id: 10, benefit: " Acute Medication R1 500 per Insured. Max R190 per script. Combined with OTC benefit "},
      {id: 11, benefit: " Over-the-Counter Medication (OTC) Combined with in Acute Medicine Limit "}
    ]
  },
...
export const blogs = [
  {
    ...
    summary: "Explore the vibrant yet informal grey economy through a minimalist aeril view of a bustling market of shacks highlighting the complex web of small-scale transactions", 
